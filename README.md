<!--
████████████████████████████████████████████████████████████████████████████████
█  yslx0 · 35w1 · README.md  ·  built with obsession                         █
████████████████████████████████████████████████████████████████████████████████
-->
...
[![Discord](https://img.shields.io/badge/◈_DISCORD-1a1a2e?style=for-the-badge&logo=discord&logoColor=5865F2)](https://discord.gg/)
...
const yslx0 = {
  ...
  uid:      "1686386",
  base:     "Brasil 🇧🇷",
  role:     "dev / designer / builder",
  focus:    ["interfaces", "sistemas", "experiências"],
  learning: ["TypeScript", "Docker", "Clean Architecture", "GraphQL"],
  now:      "construindo. sempre.",
  open:     true,
} as const;
```
...
<img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=yslx0&layout=compact&theme=dark&hide_border=true&title_color=e02020&text_color=888888&bg_color=0d0d0d&langs_count=8&custom_title=linguagens" />

<br/><br/>

<img src="https://streak-stats.demolab.com/?user=yslx0&theme=dark&hide_border=true&background=0d0d0d&ring=e02020&fire=e02020&currStreakLabel=e02020&sideLabels=666666&dates=444444&stroke=1a1a1a&sideNums=ffffff&currStreakNum=ffffff" width="60%" />

<br/><br/>

<img src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=yslx0&theme=transparent" width="100%" />

<br/>

<img src="https://github-profile-summary-cards.vercel.app/api/cards/stats?username=yslx0&theme=transparent" height="155em"/>
&nbsp;
<img src="https://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=yslx0&theme=transparent&utcOffset=-3" height="155em"/>
...
|:---:|:-----|:-----|:------:|:-----------|
| 01 | linguagem | TypeScript avançado | 🔴 ativo | `████████░░ 80%` |
| 02 | arquitetura | sistemas distribuídos | 🔴 estudo | `█████░░░░░ 50%` |
| 03 | backend | GraphQL | 🟡 início | `███░░░░░░░ 30%` |
| 04 | infra | Docker & CI/CD | 🟡 aprendendo | `██████░░░░ 60%` |
| 05 | frontend | React + Vite | 🟢 confortável | `█████████░ 90%` |
| 06 | database | PostgreSQL | 🟡 aprendendo | `█████░░░░░ 55%` |
...
```
  2022 ──────────────────────────────────────────────────────────────►
  │
  ├── 🔴  Hello World em C        →  a porta se abriu
  ├── 🟡  HTML & CSS              →  a web virou tela em branco
  │
  2023 ──────────────────────────────────────────────────────────────►
  │
  ├── 🔴  Python                  →  automações, scripts, projetos
  ├── 🟡  JavaScript              →  async, DOM, web real
  ├── 🔴  1º projeto real         →  aquela sensação não esquece
  │
  2024 ──────────────────────────────────────────────────────────────►
  │
  ├── 🔴  ETEC Cândido Mota       →  projetos técnicos e acadêmicos
  ├── 🟡  TypeScript              →  tipos. interfaces. satisfies.
  ├── 🔴  SUS PAINEL              →  Python · CustomTkinter · 10 módulos
  ├── 🟡  Design como disciplina  →  não só funciona — impressiona
  ├── 🔴  Toscana Pizzaria        →  landing page + SEO · 1º cliente
  │
  2025 ──────────────────────────────────────────────────────────────►
  │
  ├── 🔴  arquitetura             →  Docker, CI/CD, REST, GraphQL
  ├── 🟡  open source             →  contribuindo, aprendendo
  ├── 🔴  35w1 @ guns.lol         →  uid 1686386
  │
...
| componente | escolha |
|:----------:|:--------|
| 💻 máquina | Linux (main) · Windows (dual) |
| 🖥️ terminal | `zsh + oh-my-zsh` |
| 📝 editor | VS Code · Neovim |
| 🎨 tema | One Dark Pro · Tokyo Night |
| 🔤 fonte | **JetBrains Mono** |
| 🎧 fones | sempre. sem fone não tem código. |
| ☕ combustível | café às 23h. tradição. |
| 🌙 pico | `22h → 2h` |
...
⏱️  respondo →  à noite, geralmente
🤝  aberto   →  colaborações, projetos, ideias malucas
```
...
<img src="https://capsule-render.vercel.app/api?type=shark&color=e02020,1a0000,0d0d0d&height=120&section=footer&reversal=true&animation=fadeIn" width="100%" />

<br/>

<img src="https://komarev.com/ghpvc/?username=yslx0&label=👁+views&color=e02020&style=flat&labelColor=0d0d0d" />
&nbsp;
<img src="https://img.shields.io/badge/feito_com-obsessão-e02020?style=flat&labelColor=0d0d0d" />
&nbsp;
<img src="https://img.shields.io/badge/cada_linha-tem_propósito-e02020?style=flat&labelColor=0d0d0d" />

<br/><br/>

```
— código é arte. —
yslx0 · 35w1 · uid 1686386
```
